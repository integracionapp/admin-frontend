...
export const SeccionCrear = ({busqueda}) => {
    ...
    React.useEffect(()=>{
        ...
        if(busqueda){
            ...
            var config = {
                method: 'get',
                url: `http://${process.env.REACT_APP_API_URL}:8080/operators/find/${busqueda.itemName}`,
                headers: { 
    ...
    const crear = () => {
        ...
        var config = {
        method: 'post',
        url: `http://${process.env.REACT_APP_API_URL}:8080/operators/`,
        headers: { 
            'Authorization': `Bearer ${sessionStorage.getItem('token')}`, 
    ...
    const eliminar = () => {
        var config = {
            method: 'delete',
            url: `http://${process.env.REACT_APP_API_URL}:8080/operators/${datos.id}`,
            headers: { 
                'Authorization': `Bearer ${sessionStorage.getItem('token')}`
            }
          };
            ...
            <div className="container-seccion-crear">
                ...
                <div className="subseccion-otros-datos-operador">
                    ...
                    <div className="columna-subseccion">
                        ...
                        <div style={{width:'100%'}}>
                            <label className="etiqueta-formulario">Género</label>
                            <input value={datos.gender} name='gender' type="text" className="input-formulario" placeholder="Género" onChange={(e) => handleChange(e)}/>
                        </div>
